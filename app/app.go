...
import (
	...
	customtx "github.com/gerta-chain/core/app/tx"
	...
	"github.com/gerta-chain/core/app/ante"
	gertaappparams "github.com/gerta-chain/core/app/params"
	"github.com/gerta-chain/core/app/wasmconfig"

	// unnamed import of statik for swagger UI support
	_ "github.com/gerta-chain/core/client/docs/statik"
)
...
var (
	_ servertypes.Application = (*GertaApp)(nil)
)
...
// GertaApp extends an ABCI application, but with most of its parameters exported.
// They are exported for convenience in creating helper functions, as object
// capabilities aren't needed for testing.
type GertaApp struct {
	*baseapp.BaseApp
...
// NewGertaApp returns a reference to an initialized Gerta.
func NewGertaApp(
	logger log.Logger,
	db dbm.DB,
	...
	homePath string,
	invCheckPeriod uint,
	encodingConfig gertaappparams.EncodingConfig,
...
func (app *GertaApp) Name() string { return app.BaseApp.Name() }

// BeginBlocker application updates every begin block
func (app *GertaApp) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
	return app.mm.BeginBlock(ctx, req)
}

// EndBlocker application updates every end block
func (app *GertaApp) EndBlocker(ctx sdk.Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
	return app.mm.EndBlock(ctx, req)
}

// InitChainer application update at chain initialization
func (app *GertaApp) InitChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
...
func (app *GertaApp) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// ModuleAccountAddrs returns all the app's module account addresses.
func (app *GertaApp) ModuleAccountAddrs() map[string]bool {
...
func (app *GertaApp) LegacyAmino() *codec.LegacyAmino {
	return app.cdc
}

// AppCodec returns Gerta's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *GertaApp) AppCodec() codec.Codec {
	return app.appCodec
}

// InterfaceRegistry returns Gerta's InterfaceRegistry
func (app *GertaApp) InterfaceRegistry() types.InterfaceRegistry {
...
func (app *GertaApp) GetKey(storeKey string) *sdk.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *GertaApp) GetTKey(storeKey string) *sdk.TransientStoreKey {
...
func (app *GertaApp) GetMemKey(storeKey string) *sdk.MemoryStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *GertaApp) GetSubspace(moduleName string) paramstypes.Subspace {
...
// API server.
func (app *GertaApp) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *GertaApp) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *GertaApp) RegisterTendermintService(clientCtx client.Context) {
	tmservice.RegisterTendermintService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.interfaceRegistry)
}

// RegisterUpgradeHandlers returns upgrade handlers
func (app *GertaApp) RegisterUpgradeHandlers(cfg module.Configurator) {}
...
func (app *GertaApp) enforceStakingForVestingTokens(ctx sdk.Context, genesisState GenesisState) {
