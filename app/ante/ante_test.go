...
func createTestApp(isCheckTx bool, tempDir string) (*gertaapp.GertaApp, sdk.Context) {
	app := gertaapp.NewGertaApp(
		log.NewNopLogger(), dbm.NewMemDB(), nil, true, map[int64]bool{},
		tempDir, simapp.FlagPeriodValue, gertaapp.MakeEncodingConfig(),
